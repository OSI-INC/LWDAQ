...
procedure Tcl_CreateExitHandler(handler:pointer;data:pointer);
	cdecl; _EXT_ _TCLLIB_ name 'Tcl_CreateExitHandler';
procedure Tcl_DeleteExitHandler(handler:pointer;data:pointer);
	cdecl; _EXT_ _TCLLIB_ name 'Tcl_DeleteExitHandler';
function Tcl_CreateInterp:pointer;
	cdecl; _EXT_ _TCLLIB_ name 'Tcl_CreateInterp';
function Tcl_InterpDeleted(interp:pointer):integer;
	cdecl; _EXT_ _TCLLIB_ name 'Tcl_InterpDeleted';
