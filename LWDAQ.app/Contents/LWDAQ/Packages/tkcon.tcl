# LWDAQ Version of the Tkcon Console Program
#
# Started with tkcon.tcl downloaded in 2020 from some website,
# modified to make it run in LWDAQ with TclTk 8.6.9. Our assumption
# is that the code, written by Brent Welch and Jeffrey Hobbs, is
# open-source, and covered by the GPL license.
#
...
# [12-MAR-20] Replace 'tag configure -under" with "tag configure -underline".
# Remove the hash-bang and "exec wish" from the start of the program. Edit
# indenting in the first couple of routines, then give up for now.
