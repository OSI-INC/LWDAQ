...
# installed.
TCL_PREFIX='/home/kevan/build'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/kevan/build'
...
TCL_LIB_FLAG='-ltcl8.7'

# String to pass to linker to pick up the Tcl library from its
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/kevan/Desktop/Scratch/TclTk/TclTk8.7.a5/tcl/unix -ltcl8.7'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/kevan/build/lib -ltcl8.7'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/kevan/build/include'
...
# compiled.
TCL_SRC_DIR='/home/kevan/Desktop/Scratch/TclTk/TclTk8.7.a5/tcl'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='{/home/kevan/build/lib} '

# Tcl supports stub.
TCL_SUPPORTS_STUBS=1

# The name of the Tcl stub library (.a):
TCL_STUB_LIB_FILE='libtclstub8.7.a'

# -l flag to pass to the linker to pick up the Tcl stub library
TCL_STUB_LIB_FLAG='-ltclstub8.7'

# String to pass to linker to pick up the Tcl stub library from its
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/kevan/Desktop/Scratch/TclTk/TclTk8.7.a5/tcl/unix -ltclstub8.7'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/kevan/build/lib -ltclstub8.7'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/kevan/Desktop/Scratch/TclTk/TclTk8.7.a5/tcl/unix/libtclstub8.7.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/kevan/build/lib/libtclstub8.7.a'
