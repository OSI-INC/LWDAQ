...
# build directory.
tifftcl_BUILD_LIB_SPEC='-LD:/CM/tcltk86/rcompile/tkimg/libtiff -ltifftcl397'

# String to pass to linker to pick up the tifftcl library from its
# installed directory.
tifftcl_LIB_SPEC='-LD:/CM/tcltk86/release/lib/tifftcl3.9.7 -ltifftcl397'
...
# build directory.
tifftcl_BUILD_STUB_LIB_SPEC='-LD:/CM/tcltk86/rcompile/tkimg/libtiff -ltifftclstub397'

# String to pass to linker to pick up the tifftcl stub library from its
# installed directory.
tifftcl_STUB_LIB_SPEC='-LD:/CM/tcltk86/release/lib/tifftcl3.9.7 -ltifftclstub397'

# String to pass to linker to pick up the tifftcl stub library from its
# build directory.
tifftcl_BUILD_STUB_LIB_PATH='D:/CM/tcltk86/rcompile/tkimg/libtiff/libtifftclstub397.a'

# String to pass to linker to pick up the tifftcl stub library from its
# installed directory.
tifftcl_STUB_LIB_PATH='D:/CM/tcltk86/release/lib/tifftcl3.9.7/libtifftclstub397.a'
