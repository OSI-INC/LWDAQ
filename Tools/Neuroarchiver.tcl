...
#
# Properties of clock messages. The clock period is in clock ticks,
# where each tick is one period of 32.768 kHz. The clock frequency
# is 128 SPS.
#
	set info(clock_id) 0
	set info(clock_period) 256
# 
# The number of messages records in data and buffer. Includes null
# messages that may be generated by corruption of a recording.
#
...
# by the user (see channel_select parameter) and for each channel
