...
# variable. The event queue is LWDAQ's way of getting several independent
# processes to run at the same time without coming into conflict when they
# access shared variables and shared data acquisition hardware. The TCL
# interpreter does provide several forms of multi-tasking, but none of them are
